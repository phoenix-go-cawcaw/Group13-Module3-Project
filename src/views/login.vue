...
<!-- Toggle down the svg icon floats if it is overwhelming -->
    ...
    <div class="bg-icons-container">
      ...
      >
        <div class="icon-float">
          <svg v-if="icon.name === 'palette'" :width="icon.size" :height="icon.size" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <svg v-else-if="icon.name === 'gamepad'" :width="icon.size" :height="icon.size" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <svg v-else-if="icon.name === 'camera'" :width="icon.size" :height="icon.size" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M14.5 4h-5L7 7H4a2 2 0 00-2 2v9a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2h-3l-2.5-3z"/>
            <circle cx="12" cy="13" r="3"/>
          </svg>

          <svg v-else-if="icon.name === 'music'" :width="icon.size" :height="icon.size" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M9 18V5l12-2v13"/>
            <circle cx="6" cy="18" r="3"/>
            <circle cx="18" cy="16" r="3"/>
          </svg>

          <svg v-else-if="icon.name === 'utensils'" :width="icon.size" :height="icon.size" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 002-2V2"/>
            <path d="M7 2v20"/>
            <path d="M21 15V2a5 5 0 00-5 5v6c0 1.1.9 2 2 2h3zm0 0v7"/>
          </svg>

          <svg v-else-if="icon.name === 'dumbbell'" :width="icon.size" :height="icon.size" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M6 5v14M18 5v14M6 8H2v8h4M18 8h4v8h-4M10 12h4"/>
          </svg>

          <svg v-else-if="icon.name === 'plane'" :width="icon.size" :height="icon.size" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M17.8 19.2L16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z"/>
          </svg>

          <svg v-else-if="icon.name === 'book'" :width="icon.size" :height="icon.size" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z"/>
            <path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z"/>
          </svg>

          <svg v-else-if="icon.name === 'hammer'" :width="icon.size" :height="icon.size" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <svg v-else-if="icon.name === 'flower'" :width="icon.size" :height="icon.size" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M12 7.5a4.5 4.5 0 114.5 4.5M12 7.5A4.5 4.5 0 117.5 12M12 7.5V9m-4.5 3a4.5 4.5 0 104.5 4.5M7.5 12H9m7.5 0a4.5 4.5 0 11-4.5 4.5m4.5-4.5H15m-3 4.5V15"/>
        ...
        <div class="box-inner">
          <div class="box-header">
            <div class="icon-badge">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#bc6c25" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
@keyframes iconFloat {
  ...
  66%  { transform: translateY(-15px) rotate(-8deg) scale(1.0); }
...
.box-flap.flap-open   { transform: rotateX(-45deg); z-index: 0; }
.box-flap.flap-closed { transform: rotateX(0deg); z-index: 20; }
.box-flap.flap-opened { transform: rotateX(-85deg); z-index: 0; }
